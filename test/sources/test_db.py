...
class _Tester(object):
    ...
    def mk_key(self):
        """ Return a new generated primary key,
            or None if the key is autogenerated.
        """
        return None
    ...
    def create(self, session, key, key2):
        """ Create and return a new object(DbTextType.URL)ject.
            ...
            key will be None if the primary key is autogenerated
            key2 will be None if there is no secondary key
        """
        raise NotImplementedError
...
def test_notes():
    ...
    for add in adds:
        # FIXME: this test doesn't work when the folder create
