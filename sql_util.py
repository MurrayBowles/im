...
class JoinState:
    ...
    def __init__(self, tbl_desc: TblDesc):
        ...
        self.chains = []
        self.sql_strs = []
        self.select_cols = {}   # map: db_name -> (select_strs[] col_idx, col_desc)
        self.select_strs = []

    def _register_join_chain(self, join_chain: List[ColDesc]):
        ''' Return idx, l: a join_chains col_idx, the length of the match.
        cases:
            ...
            3. no match: idx is the col_idx of a new empty list added to join_chains, l == 0
        '''
